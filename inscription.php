...
// TABLE users
// id,nom (60),email(120),password(255),created_at(datetime), token(255), varchar (10)
$errors = array();
...
<form method="POST" action="inscription.php" id="forminscription" novalidate>
    <!-- nom -->
    <input type="text" name="nom" id="nom" class="form-control" value="<?php if (!empty($_POST['nom'])) {
                                                                            echo $_POST['nom'];
                                                                        } ?>" placeholder="Nom" />
    ...
    <!-- nom -->
    <input type="text" name="prenom" id="prenom" class="form-control" value="<?php if (!empty($_POST['prenom'])) {
                                                                                    echo $_POST['prenom'];
                                                                                } ?>" placeholder="Prénom" />
    ...
    <span class="error"><?php if (!empty($errors['password2'])) {
